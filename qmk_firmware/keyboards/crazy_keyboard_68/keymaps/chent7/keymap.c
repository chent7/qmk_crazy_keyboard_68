...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |----------------------------------------------------------------|
     * |Ctrl|Win |Alt |        Space          |Fn  |V+ |V- |Lef|Dow|Rig |
     * `----------------------------------------------------------------'
     */
    [_BASE] = LAYOUT_65_ansi(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                    MO(_FN), KC__VOLUP, KC__VOLDOWN, KC_LEFT, KC_DOWN, KC_RGHT
    ),
     ...
     * |----------------------------------------------------------------|
     * |        |MOD|HUI|HUD|SAI|SAD|VAI|VAD|   |   |   |      |VAI|    |
     * |----------------------------------------------------------------|
     * |Reset|   |    |                       |   |   |    |HUD|VAD|HUI |
     * `----------------------------------------------------------------'
     */
    [_FN] = LAYOUT_65_ansi(
        ...
        _______,          RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, _______, _______, _______, _______, RGB_VAI, _______,
        RESET,   _______, _______,                            _______,                   _______, _______, _______, RGB_HUD, RGB_VAD, RGB_HUI
    )
};
